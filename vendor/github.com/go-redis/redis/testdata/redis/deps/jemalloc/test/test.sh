...
for t in $@; do
  ...
  echo "=== ${t} ==="
  ${t} /home/lihang/workspace/redis_cluster_test/redis/testdata/redis/deps/jemalloc/ /home/lihang/workspace/redis_cluster_test/redis/testdata/redis/deps/jemalloc/
  result_code=$?
  case ${result_code} in
    ${pass_code})
